  ...
  it(
    ...
    () => {
      ...
      cy.get(byDataTestId(TID.USER_INPUT_FIRST_NAME))
        .should('exist')
        .type(Cypress.env('SMOKE_TEST_USER_NAME'))
      cy.get(byDataTestId(TID.USER_INPUT_LAST_NAME))
        .should('exist')
        .type(Cypress.env('SMOKE_TEST_USER_LAST_NAME'))
      ...
      cy.get(byDataTestId(TID.USER_INPUT_EMAIL))
        .should('exist')
        .type(Cypress.env('SMOKE_TEST_USER_EMAIL'))
      cy.get(byDataTestId(TID.USER_INPUT_PHONE_NUMBER))
        .should('exist')
        .type(Cypress.env('SMOKE_TEST_USER_PHONE'))
      cy.get(byDataTestId(TID.USER_INPUT_URBAN_SPORT_NUMBER))
        .should('exist')
        .type(Cypress.env('SMOKE_TEST_URBAN_SPORTS_NO'))
